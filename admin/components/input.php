   ...
   */
   public function render()
   {
      switch ($this->inputType) {
         case 'textarea':
         return "<textarea name=$this->columnName rows='8' cols='80' placeholder=$this->columnName></textarea>";
         break;

         default:
         return "<input type=$this->inputType name=$this->columnName placeholder=$this->columnName>";
         break;
      }
   }
