      ...
      <?php foreach ($gannwp_users_roles as $key => $value) : ?>
         ...
         <div>
            <form class="" action="" method="post">
               ...
               <span>
                  <input type="text" name="description" maxlength="60" value="<?php echo $value->description ?>">
               </span>
               <span>
      ...
      <div>
         <form class="" action="" method="post">
            ...
            <span>
               ...
               <input type="text" name="name" maxlength="60" value="<?php echo substr(str_shuffle("qwertyuiopasdfghjklzxcvbnm"),0,5); ?>">
               <label for="description">ajouter une description</label>
               <input type="text" name="description" maxlength="60" value="<?php echo substr(str_shuffle("qwertyuiopasdfghjklzxcvbnm"),0,5); ?>">
