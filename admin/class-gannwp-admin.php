...
class Gannwp_Admin {
	 ...
	 * @param      string    $version    The version of this plugin.
	 */
	public function __construct( $gannwp, $version, $plugin_main ) {
    ...
    public function create_menu() {
        ...
        $config_submenu = array(
            ...
            'id'                => $this->gannwp,              // Required, meta box id, unique per page, to save: get_option( id )
            ...
            'plugin_basename'   =>  plugin_basename( plugin_dir_path( __DIR__ ) . $this->gannwp . '.php' ),
            // 'tabbed'            => false,
        ...
        $config_metabox = array(
            ...
            'id'                => $this->gannwp,              // Required, meta box id, unique, for saving meta: id[field-id]
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                array(
                    'id'          => 'accordion_1',
                    'type'        => 'accordion',
                    'title'       => esc_html__( 'Accordion', 'gannwp' ),
                    'options' => array(
                        ...
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Accordion 1 Text 1', 'gannwp' ),
                                    'default' => 'default text',
                                ),
                        ...
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Accordion 2 Text 1', 'gannwp' ),
                                ),

                                array(
                                    'id'    => 'accordion_1_section_2_text_2',
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Accordion 2 Text 2', 'gannwp' ),
                                ),
                        ...
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Accordion 3 Text 1', 'gannwp' ),
                                ),

                                array(
                                    'id'    => 'accordion_1_section_3_text_2',
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Accordion 3 Text 2', 'gannwp' ),
                                ),
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                array(
                    'type'    => 'fieldset',
                    'id'      => 'fieldset_1',
                    'title'   => esc_html__( 'Fieldset field', 'gannwp' ),
                    'description'   => esc_html__( 'Cols can be 1 to 4 and 6.', 'gannwp' ) . '<br>' . esc_html__( 'Three cols per row.', 'gannwp' ),
                    'options' => array(
                        'cols' => 3,
                    ),
                    'fields'  => array(
                        ...
                        array(
                             ...
                             'type'    => 'switcher',
                             'title'   => esc_html__( 'Switcher', 'gannwp' ),
                             'default' => 'yes',
                         ),
                    ),
                ),
                ...
                array(
                    ...
                    'id'      => 'fieldset_2',
                    'title'   => esc_html__( 'Fieldset field', 'gannwp' ),
                    'description'   => esc_html__( 'E.g.: use for border, but can be used for many things, link dimensions or spacing, etc...', 'gannwp' ) . '<br>' . esc_html__( 'Two cols per row.', 'gannwp' ),
                    'options' => array(
                        'cols' => 2,
                    ),
                    'fields'  => array(
                        ...
                        array(
                            ...
                            'append'  => 'px',
                            'attributes' => array(
                                'placeholder' => esc_html__( 'top', 'gannwp' ),
                            ),
                        ),
                        ...
                        array(
                            ...
                            'append'  => 'px',
                            'attributes' => array(
                                'placeholder' => esc_html__( 'bottom', 'gannwp' ),
                            ),
                        ),
                        ...
                        array(
                            ...
                            'append'  => 'px',
                            'attributes' => array(
                                'placeholder' => esc_html__( 'left', 'gannwp' ),
                            ),
                        ),
                        ...
                        array(
                            ...
                            'append'  => 'px',
                            'attributes' => array(
                                'placeholder' => esc_html__( 'right', 'gannwp' ),
                            ),
                        ),
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                array(
                    'type'    => 'group',
                    'id'      => 'group_1',
                    'title'   => esc_html__( 'Group field nested (3 level)', 'gannwp' ),
                    'options' => array(
                        'repeater'          => true,
                        'accordion'         => true,
                        'button_title'      => esc_html__( 'Add new (L1)', 'gannwp' ),
                        'group_title'       => esc_html__( 'Accordion Title', 'gannwp' ),
                        'limit'             => 50,
                        'sortable'          => true,
                    ),
                    'fields'  => array(
                        ...
                        array(
                            ...
                            'attributes' => array(
                                ...
                                'data-title' => 'title',
                                'placeholder' => esc_html__( 'Some text', 'gannwp' ),
                            ),
                        ),
                        ...
                        array(
                            'type'    => 'group',
                            'id'      => 'group_1_group_1',
                            'title'   => esc_html__( 'Group field', 'gannwp' ),
                            'options' => array(
                                'repeater'          => true,
                                'accordion'         => true,
                                'button_title'      => esc_html__( 'Add new (L2)', 'gannwp' ),
                                'group_title'       => esc_html__( 'Accordion Title', 'gannwp' ),
                                'limit'             => 50,
                                'sortable'          => true,
                            ),
                            'fields'  => array(
                                ...
                                array(
                                    ...
                                    'options' => array(
                                        'repeater'          => true,
                                        'accordion'         => true,
                                        'button_title'      => esc_html__( 'Add new (L3)', 'gannwp' ),
                                        'group_title'       => esc_html__( 'Accordion Title', 'gannwp' ),
                                        'limit'             => 50,
                                        'sortable'          => true,
                                    ),
                ...
                array(
                    ...
                    'options' => array(
                        'repeater'          => true,
                        'accordion'         => true,
                        'button_title'      => esc_html__( 'Add new', 'gannwp' ),
                        'group_title'       => esc_html__( 'Accordion Title', 'gannwp' ),
                        'limit'             => 50,
                        'sortable'          => true,
                    ),
                    'fields'  => array(
                        ...
                        array(
                            ...
                            'type'           => 'select',
                            'title'          => esc_html__( 'Users Email (callback)', 'gannwp' ),
                            'query'          => array(
                                'type'          => 'callback',
                        ...
                        array(
                            'id'          => 'group_2_tabbed_1',
                            'type'        => 'tab',
                            'title'       => esc_html__( 'Tab same with', 'gannwp' ),
                            'options'     => array(
                                'equal_width' => true,
                            ),
                            'tabs'        => array(
                                ...
                                array(
                                    'title'  => '<i class="fa fa-microchip" aria-hidden="true"></i> ' . esc_html__( 'Tab 1', 'gannwp' ),
                                    'icon'   => 'fa fa-star',
                                    'fields' => array(
                                        ...
                                        array(
                                            ...
                                            'type'  => 'text',
                                            'title' => esc_html__( 'Tab 1 Text 1', 'gannwp' ),
                                        ),
                                ...
                                array(
                                    'title'  => '<i class="fa fa-superpowers" aria-hidden="true"></i> ' . esc_html__( 'Tab 2', 'gannwp' ),
                                    'fields' => array(

                                        array(
                                            'id'    => 'group_2_tab_2_text_text_1',
                                            'type'  => 'text',
                                            'title' => esc_html__( 'Tab 2 Text 2', 'gannwp' ),
                                        ),
                ...
                array(
                    'type'    => 'group',
                    'id'      => 'group_3',
                    'title'   => esc_html__( 'Group field not an accordion', 'gannwp' ),
                    'options' => array(
                        'repeater'          => true,
                        'accordion'         => true,
                        // 'accordion'         => false,
                ...
                array(
                    'type'    => 'group',
                    'id'      => 'group_4_sortable',
                    'title'   => esc_html__( 'Sortable, repetable field multiple', 'gannwp' ),
                    'options' => array(
                        'repeater'          => true,
                        'accordion'         => true,
                        'button_title'      => esc_html__( 'Add new', 'gannwp' ),
                ...
                array(
                    'type'    => 'group',
                    'id'      => 'group_5_sortable',
                    'title'   => esc_html__( 'Sortable (group) field single', 'gannwp' ),
                    'options' => array(
                        'repeater'          => true,
                        'accordion'         => false,
                        'button_title'      => esc_html__( 'Add new', 'gannwp' ),
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                array(
                    ...
                    'layout'      => 'vertical',
                    'radio'       => true,
                    'description' => esc_html__( 'Vertical layot, could be used for e.g. header styles.', 'gannwp' ),
                ),
        ...
        $fields[] = array(
            ...
            'fields' => array(
                ...
                array(
                    'id'          => 'tabbed_1',
                    'type'        => 'tab',
                    'title'       => esc_html__( 'Nested Tabs with same width', 'gannwp' ),
                    'options'     => array(
                        'equal_width' => true,
                    ),
                    'tabs'        => array(
                        ...
                        array(
                            ...
                            'fields' => array(
                                    ...
                                    array(
                                        'id'          => 'tabbed_1_tab1',
                                        'type'        => 'tab',
                                        'title'       => esc_html__( 'Tab same width', 'gannwp' ),
                                        'options'     => array(
                                            'equal_width' => true,
                                        ),
                                        'tabs'        => array(
                        ...
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'type'    => 'ace_editor',
                                    'title'   => esc_html__( 'Tab 1 ACE Editor 1', 'gannwp' ),
                                    'options' => array(
                                        'theme'                     => 'ace/theme/chrome',
                                        'mode'                      => 'ace/mode/javascript',
                                        'showGutter'                => true,
                ...
                array(
                    ...
                    'tabs'        => array(
                        ...
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    ...
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Tab 3 Text 1', 'gannwp' ),
                                ),

                                array(
                                    'id'      => 'tabbed_3_tab_1_ace_editor_1',
                                    'type'    => 'ace_editor',
                                    'title'   => esc_html__( 'Tab 3 ACE Editor 1', 'gannwp' ),
                                    'options' => array(
                                        'theme'                     => 'ace/theme/chrome',
                                        'mode'                      => 'ace/mode/javascript',
                                        'showGutter'                => true,
                        ...
                        array(
                            'title'  => esc_html__( 'Tab 4', 'gannwp' ),
                            'fields' => array(

                                array(
                                    'id'    => 'tabbed_3_tab_1_text_2',
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Tab 4 Text 1', 'gannwp' ),
                                ),

                                array(
                                    'id'    => 'tabbed_3_tab_1_text_3',
                                    'type'  => 'text',
                                    'title' => esc_html__( 'Tab 4 Text 2', 'gannwp' ),
                                ),
    ...
    public function manage_test_posts_columns( $columns ) {
        ...
        $columns['thumbnail'] = '';
        $columns['text_1'] = esc_attr__( 'Text', 'gannwp' );
        $columns['color_2'] = esc_attr__( 'Color', 'gannwp' );
        $columns['date_2'] = esc_attr__( 'Date', 'gannwp' );
    ...
    public function manage_posts_custom_column( $column, $post_id ) {
        ...
        // $meta = maybe_unserialize( $custom[$this->gannwp][0] );
